...
DOMAIN_TERMS = [
    # original vocabulary
    "termin", "mitarbeiter", "personal", "arzt", "behandler", "zimmer",
    "raum", "plan", "kalender", "patient", "filiale", "standort", "buchung",
    "agenda",
    # added: HR / working-time vocabulary the original run missed
    "schicht", "dienst", "arbeit", "zeit", "präsenz", "praesenz", "anwes",
    "abwes", "ferien", "urlaub", "stunde", "einsatz", "verfüg", "verfueg",
    "woche", "pause", "profil", "person", "mitarb", "team", "gruppe",
    "zutritt", "praxis", "beh",
]
